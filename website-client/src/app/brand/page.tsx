    ...
    <div className="relative bg-anna-background">
      ...
      <div className="xl:hidden bg-anna-background text-anna-foreground min-h-screen flex flex-col pt-16">
        <main className="flex-grow px-5 py-6">
          ...
          <p className="font-display text-[18px] font-normal leading-relaxed text-anna-foreground mb-6">
            At Annavalam, we believe true beauty and health begin with nature. Inspired by timeless Siddha
            wisdom and traditional ingredients, we craft products that nourish the body inside and out from
            wholesome health mixes and Karuppu Kavuni Kanji Mix to deeply nourishing hair oils and
            herbal face packs.
          ...
          <div className="relative h-[250px] w-full overflow-hidden rounded-lg mb-8">
            <Image
              src="/brand-images/image 33.png"
              alt="Traditional herbs, grains, and spices"
              fill
              priority
              className="object-cover"
              sizes="100vw"
          ...
          <section className="flex flex-col gap-8">
            <div className="flex flex-col gap-4">
              ...
              <div>
                <p className="font-script text-[28px] font-normal leading-none text-anna-foreground">
                  Sustainability
                </p>
                <h2 className="font-display text-[26px] font-bold leading-tight text-anna-foreground mt-1">
                  Responsibly sourced
                </h2>
                <p className="mt-3 font-sans text-base font-normal leading-relaxed text-anna-charcoal">
                  We&apos;re proud to source our ingredients responsibly,
                  placing a high emphasis on ethical and sustainable
                  methods. This ensures that our supplements not
                  only offer you health benefits, but also promote a
          ...
          <section className="mt-10 grid grid-cols-2 gap-4">
            <Link href="/values" className="relative h-[180px] overflow-hidden rounded-lg block hover:opacity-95 transition-opacity">
              <Image
                src="/brand-images/Rectangle 32.png"
                alt="Values link"
                fill
                ...
                sizes="50vw"
              />
              <div className="absolute bottom-3 left-3 rounded-md border border-white/85 bg-white/5 px-4 py-1.5">
                <span className="font-display text-[18px] text-white">Values</span>
              </div>
            </Link>

            <Link href="/ingredients" className="relative h-[180px] overflow-hidden rounded-lg block hover:opacity-95 transition-opacity">
              <Image
                src="/brand-images/Rectangle 33.png"
                alt="Ingredients link"
                fill
                className="object-cover"
                sizes="50vw"
              />
              <div className="absolute bottom-3 left-3 rounded-md border border-black/85 bg-white/5 px-4 py-1.5">
                <span className="font-display text-[18px] text-anna-foreground">Ingredients</span>
              </div>
            </Link>
          </section>
        </main>
