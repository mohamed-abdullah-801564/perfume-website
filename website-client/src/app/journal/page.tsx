...
export default function JournalAllPage() {
   ...
   const colW     = (1340 - 56) / 3;          // ~428
const imgH     = Math.round(colW * 3 / 4); // ~321
const cardH    = imgH + 14 + 42 + 8 + 20;  // ~405
const gridH    = 3 * cardH + 2 * 60;       // ~1335 (3 rows of 8 items)

const footerTop    = 100 + 120 + 60 + gridH + 80; // pt + title + mt + grid + padding
